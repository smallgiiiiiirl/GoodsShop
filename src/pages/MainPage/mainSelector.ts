...
export const getGoods = (state: RootStore): State["goods"] =>
  getMainSlice(state).goods;

export const getTotal = (state: RootStore): State["total"] =>
  getMainSlice(state).total;

export const getLoadStatus = (state: RootStore): State["loadStatus"] =>
  getMainSlice(state).loadStatus;
